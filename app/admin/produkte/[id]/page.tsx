...
export default function AdminProduktBearbeitenPage() {
    ...
    try {
      ...
      if (res.ok) {
        ...
        setFormData({
          ...
          specs: data.specs.length > 0 ? data.specs : [''],
      ...
      <main className="pt-20 xl:pt-6 xl:ml-64 px-4 sm:px-6 pb-8">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mb-6 sm:mb-8">
            ...
            <h1 className="text-3xl font-bold text-foreground">Produkt bearbeiten</h1>
